...
if (any(c(summary(linear_Model)$coefficients[1:4,4])>0.05)){
  print( "The coefficients in the model are not significant, please be careful with the conclusions you may obtain from it")
}
```
